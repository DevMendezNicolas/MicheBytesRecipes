...
namespace MicheBytesRecipes.Classes.Recetas
{
        ...
        internal class Ingrediente
        {
            ...
            public Ingrediente(string nombre, decimal cantidad, UnidadMedida unidad, Origen tipoOrigen)
            {
                this.Nombre = nombre;
            ...
            {
                return ValidarNombre() && ValidarCantidad() && ValidarUnidad() && ValidarOrigen();
            }

            // Metodo para obtener el detalle del ingrediente
            public string Detalle()
            {
                return $"{Cantidad} {Unidad} de {Nombre} ({TipoOrigen})";
            }
            public Ingrediente Clonar()
            {
                return new Ingrediente(this.Nombre, this.Cantidad, this.Unidad, this.TipoOrigen);
            } //Consultar aca
